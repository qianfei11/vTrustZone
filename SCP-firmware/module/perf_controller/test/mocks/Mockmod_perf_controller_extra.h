...
#define get_limiters_min_power_limit_stub_IgnoreAndReturn(cmock_retval) get_limiters_min_power_limit_stub_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void get_limiters_min_power_limit_stub_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, uint32_t cmock_to_return);
#define get_limiters_min_power_limit_stub_StopIgnore() get_limiters_min_power_limit_stub_CMockStopIgnore()
void get_limiters_min_power_limit_stub_CMockStopIgnore(void);
#define get_limiters_min_power_limit_stub_ExpectAnyArgsAndReturn(cmock_retval) get_limiters_min_power_limit_stub_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void get_limiters_min_power_limit_stub_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line, uint32_t cmock_to_return);
#define get_limiters_min_power_limit_stub_ExpectAndReturn(domain_ctx, cmock_retval) get_limiters_min_power_limit_stub_CMockExpectAndReturn(__LINE__, domain_ctx, cmock_retval)
...
typedef uint32_t (* CMOCK_get_limiters_min_power_limit_stub_CALLBACK)(struct mod_perf_controller_domain_ctx* domain_ctx, int cmock_num_calls);
...
#define get_limiters_min_power_limit_stub_StubWithCallback get_limiters_min_power_limit_stub_Stub
#define get_limiters_min_power_limit_stub_ExpectWithArrayAndReturn(domain_ctx, domain_ctx_Depth, cmock_retval) get_limiters_min_power_limit_stub_CMockExpectWithArrayAndReturn(__LINE__, domain_ctx, domain_ctx_Depth, cmock_retval)
...
#define get_limiters_min_power_limit_stub_ReturnThruPtr_domain_ctx(domain_ctx) get_limiters_min_power_limit_stub_CMockReturnMemThruPtr_domain_ctx(__LINE__, domain_ctx, sizeof(struct mod_perf_controller_domain_ctx))
#define get_limiters_min_power_limit_stub_ReturnArrayThruPtr_domain_ctx(domain_ctx, cmock_len) get_limiters_min_power_limit_stub_CMockReturnMemThruPtr_domain_ctx(__LINE__, domain_ctx, cmock_len * sizeof(*domain_ctx))
#define get_limiters_min_power_limit_stub_ReturnMemThruPtr_domain_ctx(domain_ctx, cmock_size) get_limiters_min_power_limit_stub_CMockReturnMemThruPtr_domain_ctx(__LINE__, domain_ctx, cmock_size)
...
#define get_limiters_min_power_limit_stub_IgnoreArg_domain_ctx() get_limiters_min_power_limit_stub_CMockIgnoreArg_domain_ctx(__LINE__)
...
#define domain_apply_performance_granted_stub_IgnoreAndReturn(cmock_retval) domain_apply_performance_granted_stub_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void domain_apply_performance_granted_stub_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, int cmock_to_return);
#define domain_apply_performance_granted_stub_StopIgnore() domain_apply_performance_granted_stub_CMockStopIgnore()
void domain_apply_performance_granted_stub_CMockStopIgnore(void);
#define domain_apply_performance_granted_stub_ExpectAnyArgsAndReturn(cmock_retval) domain_apply_performance_granted_stub_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void domain_apply_performance_granted_stub_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line, int cmock_to_return);
#define domain_apply_performance_granted_stub_ExpectAndReturn(domain_ctx, cmock_retval) domain_apply_performance_granted_stub_CMockExpectAndReturn(__LINE__, domain_ctx, cmock_retval)
...
typedef int (* CMOCK_domain_apply_performance_granted_stub_CALLBACK)(struct mod_perf_controller_domain_ctx* domain_ctx, int cmock_num_calls);
...
#define domain_apply_performance_granted_stub_StubWithCallback domain_apply_performance_granted_stub_Stub
#define domain_apply_performance_granted_stub_ExpectWithArrayAndReturn(domain_ctx, domain_ctx_Depth, cmock_retval) domain_apply_performance_granted_stub_CMockExpectWithArrayAndReturn(__LINE__, domain_ctx, domain_ctx_Depth, cmock_retval)
...
#define domain_apply_performance_granted_stub_ReturnThruPtr_domain_ctx(domain_ctx) domain_apply_performance_granted_stub_CMockReturnMemThruPtr_domain_ctx(__LINE__, domain_ctx, sizeof(struct mod_perf_controller_domain_ctx))
#define domain_apply_performance_granted_stub_ReturnArrayThruPtr_domain_ctx(domain_ctx, cmock_len) domain_apply_performance_granted_stub_CMockReturnMemThruPtr_domain_ctx(__LINE__, domain_ctx, cmock_len * sizeof(*domain_ctx))
#define domain_apply_performance_granted_stub_ReturnMemThruPtr_domain_ctx(domain_ctx, cmock_size) domain_apply_performance_granted_stub_CMockReturnMemThruPtr_domain_ctx(__LINE__, domain_ctx, cmock_size)
...
#define domain_apply_performance_granted_stub_IgnoreArg_domain_ctx() domain_apply_performance_granted_stub_CMockIgnoreArg_domain_ctx(__LINE__)
