...
#define set_power_limit_IgnoreAndReturn(cmock_retval) set_power_limit_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void set_power_limit_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, int cmock_to_return);
#define set_power_limit_StopIgnore() set_power_limit_CMockStopIgnore()
void set_power_limit_CMockStopIgnore(void);
#define set_power_limit_ExpectAnyArgsAndReturn(cmock_retval) set_power_limit_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void set_power_limit_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line, int cmock_to_return);
#define set_power_limit_ExpectAndReturn(id, power_limit, cmock_retval) set_power_limit_CMockExpectAndReturn(__LINE__, id, power_limit, cmock_retval)
...
typedef int (* CMOCK_set_power_limit_CALLBACK)(fwk_id_t id, uint32_t power_limit, int cmock_num_calls);
...
#define set_power_limit_StubWithCallback set_power_limit_Stub
#define set_power_limit_IgnoreArg_id() set_power_limit_CMockIgnoreArg_id(__LINE__)
void set_power_limit_CMockIgnoreArg_id(UNITY_LINE_TYPE cmock_line);
#define set_power_limit_IgnoreArg_power_limit() set_power_limit_CMockIgnoreArg_power_limit(__LINE__)
